export const info = {
  ...
  `,
	...
	projects: [
		{
			title: "Shortly - Shorter Links (Vue.js)",
			isFeatured: true,
		...
		{
			title: "Ecommerce Dashboard (Next.js)",
			isFeatured: true,
		...
		{
			title: "Suscribe Multiform (Astro.build)",
			isFeatured: false,
		...
		},
		{
			...
			liveUrl: "https://movieland-lyart.vercel.app/",
		},
	],
};
